...
namespace DesktopCleaner.DllUse
{
    public class Functions
    {
        ...
        /// 获取Public Desktop
        /// </summary>
        /// <returns>Public Desktop的路径</returns>
        ...
        {
            FileHelper.DCC("INIWrite",section, key, value, path);
        }
        ...
        {
            return GetFileIcon(fileName, isSmallIcon, out _);
        }
        ...
        {
            return GetFolderIcon(isSmallIcon, out _);
        }
        ...
        {
            return GetDriverIcon(driverMark, isSmallIcon, out _);
        }
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        internal static string SizeContent(long v)
        {
            string[] unit = { "B","KB","MB","GB" };
            int i = 0;
            while (i < unit.Length && v > 1024) 
            {
                v >>= 10;
                i++;
            }
            return v.ToString()+unit[i];
        }
        public static string SelectFile()
        {
            ...
            {
                Filter = "所有文件|*.*",//如果需要筛选txt文件（"Files (*.txt)|*.txt"）
                Title = "请选择文件",
                Multiselect=true
            };
